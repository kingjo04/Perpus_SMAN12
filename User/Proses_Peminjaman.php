...
if (isset($_POST['bukuDipilih']) && isset($_POST['tanggal_pinjam']) && isset($_POST['tanggal_kembali'])) {
    ...
    foreach ($_POST['bukuDipilih'] as $key => $idKeranjang) {
        ...
        if ($jumlahBukuTersedia >= $jumlah) {
            ...
            $queryTambahPeminjaman = "INSERT INTO peminjaman (nama, nomor_buku, judul, tanggal, tenggat, jumlah, no_hp) VALUES ('$nama', '$nomor', '$judul', '$tanggal', '$tenggat', '$jumlah', '$nomorTelepon')";
